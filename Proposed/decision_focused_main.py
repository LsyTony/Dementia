...
from decision_focused_model import DecisionFocusedTransformer
import wandb
...
def generic_train(
    model: DecisionFocusedTransformer,
    ...
    **extra_train_kwargs
    ...
    )#if just test, change pl_logger.version to "version_xxxx" folder that contains the model
...
def main():
    ...
    parser = DecisionFocusedTransformer.add_model_specific_args(parser, os.getcwd())
    ...
    model = DecisionFocusedTransformer(args)
