...
def ToSummary(summary_dataset: pd.DataFrame, mark:str) -> pd.DataFrame:
    for i,row in enumerate(summary_dataset.itertuples()):
        ...
        if i%200==0:
            if mark == "case":
                summary_dataset.to_csv("/geode2/projects/iu/IN-REGI-PDM/Dementia/Dementia-Workspace/Shengyang/processed_data/-2.5year_to_-0.5year/abstractive_summary_book_case_-2.5y_to_-0.5y.csv")
            elif mark == "control":
                summary_dataset.to_csv("/geode2/projects/iu/IN-REGI-PDM/Dementia/Dementia-Workspace/Shengyang/processed_data/-2.5year_to_-0.5year/abstractive_summary_book_control_-2.5y_to_-0.5y.csv")
...
summary_dataset_case.to_csv("/geode2/projects/iu/IN-REGI-PDM/Dementia/Dementia-Workspace/Shengyang/processed_data/-2.5year_to_-0.5year/abstractive_summary_book_case_-2.5y_to_-0.5y.csv")

print("begin processing control")
summary_dataset_control=ToSummary(summary_dataset_control,"control")
print(summary_dataset_control.equals(raw_dataset_control))

summary_dataset_control.to_csv("/geode2/projects/iu/IN-REGI-PDM/Dementia/Dementia-Workspace/Shengyang/processed_data/-2.5year_to_-0.5year/abstractive_summary_book_control_-2.5y_to_-0.5y.csv")
